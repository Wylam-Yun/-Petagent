...
class ContextManager:
    ...
    def build(
        ...
        if profile == "unified":
            ...
            effective_recent_turns = 6
            effective_memory_items = 0  # V1.3: card-only, no scored memories
            include_daily_digest = False
            include_episode_summaries = False
            include_important_quotes = False
        elif profile == "recall":
            ...
            effective_memory_items = 0  # V1.3: card-only
            include_daily_digest = False
            include_episode_summaries = False
            include_important_quotes = False
        ...
        # Only recall profile loads temporal recall (V1.3: thinking/fast_reply disable it)
        if profile == "recall" and event_log_store and self._wants_temporal_recall(event):
